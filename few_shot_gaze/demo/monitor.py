...
class monitor:
    ...
    def __init__(self):qqqq
        display = Gdk.Display.get_default() #return gdk.display
        screen = display.get_default_screen() #return gdk.screen
        default_screen = screen.get_default() #return gdk.screen
        num = default_screen.get_number() #Gets the index of self among the screens in the display to which it belongs. (See Gdk.Screen.get_display())
