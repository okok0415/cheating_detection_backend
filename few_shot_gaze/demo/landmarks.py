...
from few_shot_gaze.demo.ext.HRNet_Facial_Landmark_Detection.lib.config import config
import few_shot_gaze.demo.ext.HRNet_Facial_Landmark_Detection.lib.models as models
# from few_shot_gaze.demo.ext.HRNet_Facial_Landmark_Detection.lib.datasets import get_dataset
from few_shot_gaze.demo.ext.HRNet_Facial_Landmark_Detection.lib.core import evaluation
from few_shot_gaze.demo.ext.HRNet_Facial_Landmark_Detection.lib.utils import transforms
...
class landmarks:
    ...
    def __init__(self, config=config):
        ...
        config.defrost()
        config.merge_from_file("few_shot_gaze/demo/ext/HRNet_Facial_Landmark_Detection/experiments/wflw/face_alignment_wflw_hrnet_w18.yaml")
        config.freeze()
        ...
        state_dict = torch.load("few_shot_gaze/demo/ext/HRNet_Facial_Landmark_Detection/hrnetv2_pretrained/HR18-WFLW.pth")
